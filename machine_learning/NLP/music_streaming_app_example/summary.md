<!-- タイトル: カルーセルUIの特性を考慮した推薦モデルを作るために、banditパラメータ更新にカスケードモデルを適用する論文を読んだ! -->
...
- また、カルーセルUIの特性「ユーザはすべてのスロットを見ない可能性がある」ことを考慮して、オンライン学習時の工夫として**カスケードアーム更新モデル**を導入してる (個人的にここが本論文を読む1番のモチベーションでした...!:thinking:)
...
これはbanditモデルのパラメータ更新の話...!:thinking:
