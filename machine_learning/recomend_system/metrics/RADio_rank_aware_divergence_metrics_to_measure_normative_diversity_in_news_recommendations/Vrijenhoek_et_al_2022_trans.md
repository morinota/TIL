...
しかし、近年では、多様性と精度のトレードオフを明示的に行うニューラル・ベース・レコメンダーが注目されている[61]。
...
### Jensen–Shannon Divergence. ジェンセン・シャノン・ダイバージェンス（Jensen-Shannon Divergence）。
...
## Rank-Aware f-Divergence Metrics 順位考慮型 f-ダイバージェンスメトリクス
