...
<summary>ちなみに、評価方策が確率的な場合には、naive推定量の定義式はたぶん以下のようになるのかなと思ってます。前述の式を一般化した形ですね...!:thinking:</summary>

---

$$
\hat{V}*{naive}(\pi;D*{\pi_0}) = \frac{1}{\sum_{i=1}^{n} \pi(a_i|x_i)} \sum_{i=1}^{n} \pi(a_i|x_i) r_i
$$
