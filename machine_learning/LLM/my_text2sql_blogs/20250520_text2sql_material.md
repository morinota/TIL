...
## 余談: UberさんのText2SQLの継続的改善のための評価方法がしっかりしててよさそうだった
...
- AgenticなLLMシステムにどれくらいのアクション権限を与えるかの話:
  ...
  - AgenticなLLMシステムにおいて、モデルが呼び出すツール(i.e. アクション)は**read-only actions**と**write actions**に分類できる(参考文献1より)。
...
- Text2SQLアプリにSQL実行権限を与える場合は、どんなリスクを考慮すべきだろ?? :thinking:
