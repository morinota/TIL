...
###### 3.2.2.0.3. Online Inference Pipeline
###### 3.2.2.0.4. オンライン推論パイプライン
...
###### 3.2.2.0.5. Agentic Search for Videos
###### 3.2.2.0.6. 動画のエージェンティック検索
...
###### 3.2.2.0.7. The Dirty Dozen of Fallacies of MLOps
###### 3.2.2.0.8. MLOpsの誤謬のダーティダース
...
###### 3.2.2.0.9. The Ethical Responsibilities of AI Builders
###### 3.2.2.0.10. AIビルダーの倫理的責任
...
###### 3.2.2.0.13. A A/B tests for agents, 444 for batch inference, 397
...
###### 3.2.2.1.1. B backfilling batch data sources for, 207
...
###### 3.2.2.1.2. D DAG (see directed acyclic graph) data accuracy, 54
...
###### 3.2.2.1.3. E eager evaluation, 160 EDA (exploratory data analysis), 28, 36
...
###### 3.2.2.1.4. F fact table, 95 factorization machines, 448
...
###### 3.2.2.1.12. U u2i (user-to-item) recommendation, 448 Uber (Michelangelo platform), 12, 77 
###### 3.2.2.1.13. U u2i（ユーザーからアイテムへの）推薦、448 Uber（Michelangeloプラットフォーム）、12, 77
...
###### 3.2.2.1.14. V vector embedding pipeline, 39, 462 vector embeddings, 156, 432 
###### 3.2.2.1.15. V ベクトル埋め込みパイプライン、39, 462 ベクトル埋め込み、156, 432
...
###### 3.2.2.1.16. W weak supervision, 270 windowed aggregations, 98
###### 3.2.2.1.17. W 弱い監視、270 ウィンドウ集約、98
...
###### 3.2.2.1.18. X XGBoost, model training with, 295-296  
###### 3.2.2.1.19. X XGBoostを用いたモデルのトレーニング、295-296  

###### 3.2.2.1.20. About the Author
