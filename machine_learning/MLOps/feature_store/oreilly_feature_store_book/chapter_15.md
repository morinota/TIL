...
###### 2.0.0.0.1. Real-Time Personalized Recommender 
###### 2.0.0.0.2. リアルタイムパーソナライズドレコメンダー
...
###### 2.0.0.0.3. Feature Pipelines 
###### 2.0.0.0.4. フィーチャーパイプライン
...
###### 2.0.0.0.5. Training Pipelines
###### 2.0.0.0.6. トレーニングパイプライン
...
###### 2.0.0.0.7. Two-tower embedding model
###### 2.0.0.0.8. ツータワー埋め込みモデル
...
###### 2.0.0.0.9. Building the vector index of videos
###### 2.0.0.0.10. ビデオのベクトルインデックスの構築
...
###### 2.0.0.0.13. Online Inference Pipeline
###### 2.0.0.0.14. オンライン推論パイプライン
...
###### 2.0.0.0.15. Agentic Search for Videos
###### 2.0.0.0.16. 動画のエージェンティック検索
...
###### 2.0.0.0.17. The Dirty Dozen of Fallacies of MLOps
###### 2.0.0.0.18. MLOpsの誤謬のダーティダース
...
###### 2.0.0.0.19. The Ethical Responsibilities of AI Builders
###### 2.0.0.0.20. AIビルダーの倫理的責任
...
###### 2.0.0.0.23. A A/B tests for agents, 444 for batch inference, 397
...
###### 2.0.0.1.1. B backfilling batch data sources for, 207
...
###### 2.0.0.1.2. D DAG (see directed acyclic graph) data accuracy, 54
...
###### 2.0.0.1.3. E eager evaluation, 160 EDA (exploratory data analysis), 28, 36
...
###### 2.0.0.1.4. F fact table, 95 factorization machines, 448
...
###### 2.0.0.1.12. U u2i (user-to-item) recommendation, 448 Uber (Michelangelo platform), 12, 77 
###### 2.0.0.1.13. U u2i（ユーザーからアイテムへの）推薦、448 Uber（Michelangeloプラットフォーム）、12, 77
...
###### 2.0.0.1.14. V vector embedding pipeline, 39, 462 vector embeddings, 156, 432 
###### 2.0.0.1.15. V ベクトル埋め込みパイプライン、39, 462 ベクトル埋め込み、156, 432
...
###### 2.0.0.1.16. W weak supervision, 270 windowed aggregations, 98
###### 2.0.0.1.17. W 弱い監視、270 ウィンドウ集約、98
...
###### 2.0.0.1.18. X XGBoost, model training with, 295-296  
###### 2.0.0.1.19. X XGBoostを用いたモデルのトレーニング、295-296  

###### 2.0.0.1.20. About the Author
