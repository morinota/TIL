...
## 0.1. Unstructured Data and Labels in Feature Groups 非構造化データとフィーチャーグループにおけるラベル
...
### 0.1.1. Self-Supervised and Unsupervised Learning 自己教師あり学習と教師なし学習
...
### 0.2.1. Supervised Learning Requires a Label 教師あり学習はラベルを必要とする
...
0.3. Cleanlabは、非構造化データと構造化データの両方のラベルデータを修正/クリーンアップすることもできます。
---
...
## 0.4. Root and Label Feature Groups ルートおよびラベル特徴グループ
...
###### 0.4.0.0.0.4. Training Data
###### 0.4.0.0.0.5. トレーニングデータ
...
###### 0.4.0.0.0.6. Splitting Training Data
###### 0.4.0.0.0.7. トレーニングデータの分割
...
###### 0.4.0.0.0.8. Reproducible Training Data
###### 0.4.0.0.0.9. 再現可能なトレーニングデータ
...
###### 1.0.0.0.0.1. Model Architecture
###### 1.0.0.0.0.2. モデルアーキテクチャ
...
###### 1.0.0.0.0.3. Checkpoints to Recover from Failures
###### 1.0.0.0.0.4. 障害から回復するためのチェックポイント
...
###### 1.0.0.0.0.5. Hyperparameter Tuning with Ray Tune
###### 1.0.0.0.0.6. Ray Tuneによるハイパーパラメータチューニング
...
###### 1.0.0.0.0.7. Distributed Training with Ray
###### 1.0.0.0.0.8. Rayによる分散トレーニング
...
###### 1.0.0.0.0.9. Parameter-Efficient Fine-Tuning of LLMs
###### 1.0.0.0.0.10. パラメータ効率の良いLLMのファインチューニング
...
###### 1.0.0.0.0.11. Credit Card Fraud Model with XGBoost
###### 1.0.0.0.0.12. XGBoostによるクレジットカード詐欺モデル
...
###### 1.0.0.0.0.13. Identifying Bottlenecks in Distributed Training
###### 1.0.0.0.0.14. 分散トレーニングにおけるボトルネックの特定
...
# 2. Summary plot to visualize feature importance   
...
###### 3.0.0.0.0.1. Model File Formats and the Model Registry
###### 3.0.0.0.0.2. モデルファイル形式とモデルレジストリ
...
-----
###### 3.0.0.0.0.5. Summary and Exercises
###### 3.0.0.0.0.6. 要約と演習
...
-----
-----
###### 3.0.0.0.0.7. PART V #### Inference and Agents  
###### 3.0.0.0.0.8. 第V部 #### 推論とエージェント  
-----
-----  
