...
# Automatic taxonomy construction / 自動分類構築

**Contents / 目次**
- 1 Approaches / 1 アプローチ
  - 1.1 Keyword extraction / 1.1 キーワード抽出
  - 1.2 Hyponymy and "is-a" relations / 1.2 下位語と「is-a」関係
- 2 Applications / 2 応用
- 3 ATC software / 3 ATCソフトウェア
- 4 Other names / 4 その他の名称
- 5 See also / 5 関連項目
- 6 References / 6 参考文献
- 7 Further reading / 7 さらなる読み物
